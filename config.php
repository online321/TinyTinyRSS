<?php
	...
	define('DB_USER', getenv('POSTGRESQL_USER'));
	define('DB_NAME', getenv('POSTGRESQL_DATABASE'));
	define('DB_PASS', getenv('POSTGRESQL_PASSWORD'));
	define('DB_PORT', getenv('POSTGRESQL_SERVICE_PORT_POSTGRESQL'));
	...
	// *****************************
        ...
        define('PHP_EXECUTABLE', shell_exec("which php"));                                                                                                                      // Path to PHP *COMMAND LINE* executable, used for various command-line tt-rss 
